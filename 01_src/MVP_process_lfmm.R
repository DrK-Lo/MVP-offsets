...
#
# This script is called from 01_src/MVP_10_train_lfmm2_offset.py
#
# Usage
# -----
# conda activate MVP_env_R4.0.3
# Rscript MVP_process_lfmm.R seed slimdir lfmm_envfile lfmm_envfile_new poplabel_file output_file cand_loci_file
#
# Parameters
# ----------
# seed
...
offset <- genetic.offset(input=input, env=env, new.env=new.env, pop.labels=pop.labels, K=K, candidate.loci=cand_loci)
