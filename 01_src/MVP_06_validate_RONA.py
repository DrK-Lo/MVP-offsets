...
def garden_performance_scatter(offset, fitness, env, locations, envdata, cols, cmap=None, norm=None, seed=None, fig_dir=None, program='RONA'):
...
def create_scatter_map(rona, fitness, locations, envdata):
...
def fill_heatmaps(garden_performance, source_performance, garden_slopes, source_slopes, locations, marker_set):
    ...
    # create figs that show the perforance across gardens for each source
    print('\t\nsaving heatmaps for the perforance across gardens for each source ...')
